...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label1.setGeometry(QtCore.QRect(250, 100, 301, 111))
        font = QtGui.QFont()
        ...
        self.actionCopy.triggered.connect(lambda: self.clicked('Copied'))
        self.actionPaste.triggered.connect(lambda: self.clicked('Pasted'))
        self.actionNew.triggered.connect(lambda: self.clicked('New File'))
        self.actionSave.triggered.connect(lambda: self.clicked('Saved'))
